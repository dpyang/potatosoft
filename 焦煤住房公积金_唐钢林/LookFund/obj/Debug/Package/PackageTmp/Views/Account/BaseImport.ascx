...
<div id="inright">
    <div id="biaoge">
        <div class="biaogeks">
            公积金数据导入</div>
        <form id="filePost" action="<%:Url.Action("BaseImport","Account") %>" method="post" enctype="multipart/form-data">
        <table width="762" cellspacing="1" bgcolor="#88C4FF">
            ...
            <tr>
                ...
                <td bgcolor="#EEF7FE">
                    <input id="Submit1" type="button" value="上传" onclick="uploadFile()" 
                        style="width: 63px" />&nbsp;&nbsp;&nbsp;&nbsp;
                    <input id="submit2" type="button" value="保存" onclick="uploadSvae()" style="width:63px"  />&nbsp;&nbsp;&nbsp;&nbsp;
